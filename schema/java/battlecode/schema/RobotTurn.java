...
public final class RobotTurn extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_23_5_26(); }
  public static RobotTurn getRootAsRobotTurn(ByteBuffer _bb) { return getRootAsRobotTurn(_bb, new RobotTurn()); }
  public static RobotTurn getRootAsRobotTurn(ByteBuffer _bb, RobotTurn obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public RobotTurn __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createRobotTurn(FlatBufferBuilder builder,
      int robotId,
      int health,
      int paint,
      int moveCooldown,
  ...
  public static void startRobotTurn(FlatBufferBuilder builder) { builder.startTable(9); }
  ...
  public static int endRobotTurn(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public RobotTurn get(int j) { return get(new RobotTurn(), j); }
    public RobotTurn get(RobotTurn obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
