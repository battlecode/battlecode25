...
(function (Action) {
    ...
    Action[Action["MopAction"] = 7] = "MopAction";
    Action[Action["BuildAction"] = 8] = "BuildAction";
    Action[Action["TransferAction"] = 9] = "TransferAction";
    Action[Action["MessageAction"] = 10] = "MessageAction";
    Action[Action["SpawnAction"] = 11] = "SpawnAction";
    Action[Action["DieAction"] = 12] = "DieAction";
    Action[Action["UpgradeAction"] = 13] = "UpgradeAction";
    Action[Action["IndicatorStringAction"] = 14] = "IndicatorStringAction";
    Action[Action["IndicatorDotAction"] = 15] = "IndicatorDotAction";
    Action[Action["IndicatorLineAction"] = 16] = "IndicatorLineAction";
