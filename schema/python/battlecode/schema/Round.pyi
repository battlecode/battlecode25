...
class Round(object):
  ...
  def TeamCoverageAmouns(self, i: int) -> typing.List[int]: ...
  def TeamCoverageAmounsAsNumpy(self) -> np.ndarray: ...
...
def RoundAddTeamCoverageAmouns(builder: flatbuffers.Builder, teamCoverageAmouns: uoffset) -> None: ...
def RoundStartTeamCoverageAmounsVector(builder: flatbuffers.Builder, num_elems: int) -> uoffset: ...
def StartTeamCoverageAmounsVector(builder: flatbuffers.Builder, num_elems: int) -> uoffset: ...
